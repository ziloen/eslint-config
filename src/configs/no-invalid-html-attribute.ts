...
// Original: https://github.com/jsx-eslint/eslint-plugin-react/blob/master/lib/rules/no-invalid-html-attribute.js
...
function report(context: Rule.RuleContext, message: string, messageId: string, data: Record<string, any>): void {
  context.report(
    Object.assign(
      { messageId },
      data
...
export const noInvalidHtmlAttribute: Rule.RuleModule = {
  meta: {
    docs: {
